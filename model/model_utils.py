...
def initilize_skeleton_and_skin(path_to_mesh,skeleton_scale = 1,skin_scale = 1):
    ...
    right_wing_center1 = Joint([0.05,-0.7,0.],[0.0,0,0], parent = right_wing_root,  scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_center1')
    right_wing_center2 = Joint([0.05,-0.9,0],[0.0,0,0], parent = right_wing_center1,  scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_center2')
    right_wing_tip = Joint([-0.25,-0.6,0],[0.0,0,0], parent = right_wing_center2, scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_tip')
    
    left_sp_no_bone = Joint([0,0,0.4],[0.0,pitch_body,0], parent = root, end_joint_of_bone = False, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_sp_no_bone')
    left_wing_root = Joint([0,0.4,-0.05],[0.0,0,0],parent = left_sp_no_bone, end_joint_of_bone = False, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_wing_root')
    left_wing_joint1 = Joint([0.05,0.7,0],[0.0,0,0], parent = left_wing_root,  scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'right_wing_center')
    left_wing_joint2 = Joint([0.05,0.9,0],[0.0,0,0], parent = left_wing_joint1,  scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'right_wing_center')
