...
class FlyOutput:
    ...
    def define_wings_interest_points(self):
        ...
        interest_points = self.interest_points_3d
        ...
        idx_right_wing = np.argmin(dist_interest_wing)
        self.interest_left_wing_boundry = wings_idx[idx_right_wing != 1]
        self.interest_right_wing_boundry = wings_idx[idx_right_wing == 1]
  

    def cyclic_sort(self,points,span,chord):
        points_2d = Utils.project_to_plane(points, np.mean(points,axis = 0), span, chord)
        return Utils.rotational_sort(points_2d, np.mean(points_2d,axis = 0), clockwise=True)
    ...
    def zsocre_ol_calc_indices(self):
        ...
        return lwing_points[indices_left_wing_bound],rwing_poins[indices_right_wing_bound],interest_left_wing[indices_interest_left_wing],interest_right_wing[indices_interest_right_wing]
