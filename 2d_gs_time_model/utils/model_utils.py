...
def initilize_skeleton_and_skin(path_to_mesh,skeleton_scale = 1,skin_scale = 1):
    ...
    right_wing_root = Joint([0,-0.3,0],[0.0,0,0], parent = right_sp_no_bone, end_joint_of_bone = False, scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_root')
    right_wing_center = Joint([0,-1.1,0],[0.0,0,0], parent = right_wing_root,  scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_center')

    right_wing_tip = Joint([0,-1.1,0],[0.0,0,0], parent = right_wing_center, scale = skeleton_scale, color = 'red',rotation_order = 'zxy',name = 'right_wing_tip')
    ...
    left_wing_root = Joint([0,0.3,0],[0.0,0,0],parent = left_sp_no_bone, end_joint_of_bone = False, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_wing_root')
    left_wing_center = Joint([0,1.1,0],[0.0,0,0], parent = left_wing_root,  scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'right_wing_center')
    left_wing_tip = Joint([0,1.1,0],[0.0,0,0], parent =left_wing_center, scale = skeleton_scale, color = 'blue',rotation_order = 'zxy',name = 'left_wing_tip')
    ...
    right_wing = Skin(f'{path_to_mesh}/right_wing_lowres.stl',scale = skin_scale,constant_weight = right_wing_root,color = 'crimson')
    left_wing = Skin(f'{path_to_mesh}/left_wing_lowres.stl',scale = skin_scale, constant_weight = left_wing_root,color = 'dodgerblue')
...
def transform_pose(points,weights,root_rotation,list_joints_pitch_update,joint_list,bones,translation,right_wing_angles,left_wing_angles,right_wing_angles_center,left_wing_angles_center):
    ...
    joint_list[8].set_local_rotation(torch.tensor(0.0).cuda(),torch.tensor(0.0).cuda(),right_wing_angles_center)


    joint_list[11].set_local_rotation(left_wing_angles[0],left_wing_angles[1],left_wing_angles[2])
    joint_list[12].set_local_rotation(torch.tensor(0.0).cuda(),torch.tensor(0.0).cuda(),left_wing_angles_center)
